...
$calendario = "SELECT * FROM Legislacao order by data desc";
...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
   <title>ETEC Amim Jundi - Legislação</title>  
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						<div class="dropdown-menu" aria-labelledby="dropdown-b">
								...
								<a class="dropdown-item active" href="legisletec.php">Legislação </a>
    ...
    <div id="overviews" class="section wb">
     ...
     <p class="lead"> 
        ...
        <?php while($rows_calendario = mysqli_fetch_assoc($consulta_calendario)){ ?>
            ...
            <p class="lead"> <a target="_blank" href="legislacao/<?php echo $rows_calendario['arquivo']; ?>">
