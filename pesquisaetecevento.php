...
<li class='page-item'><a class='page-link' href='pesquisaetecevento.php?pagina=<?php echo 1 ?>&pesquisar=<?php echo $valor_pesquisar; ?>'><span aria-hidden='true'>Primeira</span></a>
<?php
		...
		for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
			...
			?>	
<li class='page-item'><a class='page-link' href='pesquisaetecevento.php?pagina=<?php echo $quantidade_pg; ?>&pesquisar=<?php echo $valor_pesquisar; ?>'><span aria-hidden='true'>Última</span></a>
