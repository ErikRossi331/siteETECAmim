...
$result_cursos = "SELECT * FROM cursos where eixo = 'Ensino Médio';";
...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
   <title>ETEC Amim Jundi - Ensino Médio</title>  
...
<body class="host_version"> 
	...
	<div class="all-title-box">
		<div class="container text-center">
			<h1>Ensino Médio<span class="m_1">Vem pra ETEC!</span></h1>
		</div>
	</div>
        ...
        <div class="container">
            ...
            <div class="section-title row text-center">
                <div class="col-md-8 offset-md-2">
                    <p class="lead">Confira aqui todos os cursos da modalidade Ensino Médio e Ensino Médio com formativos técnicos e itinerários da ETEC Amim Jundi</p>
                </div>
            </div><!-- end title -->
                                  ...
                                  <div class="col-lg-4 col-md-6 col-sm-12">
                                  	<div class="borda">
									   <div class="full blog_img_popular">
										  ...
										  <h4><font size="3"><a href="eteccurso.php?cod_curso=<?php echo $rows_cursos['cod_curso']; ?>" class="yel"><?php echo $rows_cursos['nome']; ?></a></h4></font>
										  <p class="yel2"><font size="3">
<?php
