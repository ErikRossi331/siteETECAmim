...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
   <title>ETEC Amim Jundi - Notícias</title>  
...
<?php
		...
		$result_pg = "SELECT COUNT(cod_noticia) AS num_result FROM noticias";
...
<nav aria-label='Page navigation example'>
  <ul class='pagination center'>
    <li class='page-item'><a class='page-link' href='noticias.php?pagina=1'>Primeira</a></li>";
		
		for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
			if($pag_ant >= 1){
				echo "
				<li class='page-item'><a class='page-link' href='noticias.php?pagina=$pag_ant'>$pag_ant</a></li>";
			}
		}
		...
		for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
			if($pag_dep <= $quantidade_pg){
				echo "<li class='page-item'><a class='page-link' href='noticias.php?pagina=$pag_dep'>$pag_dep</a></li>";
			}
		}
		
		echo "<li class='page-item'><a class='page-link' href='noticias.php?pagina=$quantidade_pg'>Ultima</a>";
