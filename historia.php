...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
   <title>ETEC Amim Jundi - História</title>  
			...
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse" id="navbars-host">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item active"><a class="nav-link" href="historia.php">História</a></li>
        ...
        <div class="container">
            ...
            <div class="section-title row text-center">
                <div class="col-md-7">
                    ...
                    <h3>História da ETEC Amim Jundi</h3>
                    <div class="before"></div>
                   
                </div>
                <img src="images/ETEC-Inst.jpg" class="img-fluid img-responsive imgpers3">

                    <div id="pricing-box" class="section wb">
                        <a class="boxes" href="#local">
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-sm-6">
                    <div class="pricingTable">
                        <div class="pricingTable-header">
                            <span class="heading">
                                <h90><i class="fa fa-map-marker"></i></h90><br> Localização
                            </span>
...
<a class="boxes" href="equipeetec.php">
                <div class="col-md-4 col-sm-6">
                    <div class="pricingTable">
                        <div class="pricingTable-header">
                            <span class="heading">
                                <h90><i class="fa fa-user"></i></h90><br> Equipe de Trabalho
                            </span>
...
<a class="boxes" href="contatoetec.php">
                <div class="col-md-4 col-sm-6">
                    <div class="pricingTable">
                        <div class="pricingTable-header">
                            <span class="heading">
                                <h90><i class="fa fa-question"></i></h90><br> Fale Conosco!
                            </span>
            ...
            <p class="lea">
                O Centro Paula Souza é uma autarquia do Governo do Estado de São Paulo, vinculada à Secretaria de Desenvolvimento Econômico, Ciência, Tecnologia e Inovação (SDECTI). A instituição administra 218 Escolas Técnicas Estaduais (Etecs) e 65 Faculdades de Tecnologia (Fatecs), reunindo mais de 283 mil alunos em cursos técnicos de nível médio e superiores tecnológicos, em mais de 300 municípios.<br><br>

As Etecs atendem 212 mil estudantes nos Ensinos Técnico, Médio e Técnico Integrado ao Médio, com 135 cursos técnicos para os setores industrial, agropecuário e de serviços, incluindo habilitações na modalidade semipresencial, Educação de Jovens e Adultos (EJA) e especialização técnica.<br><br>

Já nas Fatecs, mais de 73 mil alunos estão matriculados em 72 cursos de graduação tecnológica, em diversas áreas, como Construção Civil, Mecânica, Informática, Tecnologia da Informação, Turismo, entre outras. Além da graduação, são oferecidos cursos de pós-graduação, atualização tecnológica e extensão. </p><br><br>

<h1>Fundação e Integração<br></h1>
<p class="lea">Fundada em 1962 como Ginásio Artesanal, foi transformada em Ginásio Industrial em 1972, oferecendo os cursos de Marcenaria, Mecânica e Desenho Técnico em Mecânica.
...
Em 1994 passou a integrar a rede de escolas do Centro Paula Souza, oferecendo os cursos técnicos em Enfermagem, Contabilidade e Auxiliar de Enfermagem.</p><br><br>

<h1>Introdução de Novos Cursos<br></h1>
<p class="lea"> Em 1997 foi montado o primeiro laboratório de informática da unidade, fato que possibilitou a implantação do curso Técnico em Processamento de Dados, uma solicitação antiga da comunidade. Esse curso teve sua nomenclatura alterada para Técnico em Informática no ano de 1999.
...
No segundo semestre de 2000, a Etec Amim Jundi foi incumbida da implantação e gestão de classes descentralizadas no município de Tupã, ficando responsável pela mesma até 30/03/2006, quando a extensão foi transformada em Unidade do CEETEPS, recebendo a princípio o nome de Etec de Tupã, posteriormente alterado para Etec Prof. Massuyuki Kawano.</p><br><br>

<p class="lea">Ainda no ano 2000 foram implantados os cursos de Técnico em Administração e Segurança do Trabalho. No ano seguinte, em parceria com usinas sucroalcooleiras da região, foi implantado o curso Técnico em Açúcar e Álcool. Também neste ano, foi implantado o curso Técnico em Turismo.
...
A reforma do prédio, iniciada no ano de 2009, foi concluída em 01/09/2010, num investimento total de R$ 1.762.782,07 (um milhão, setecentos e sessenta e dois mil, setecentos e oitenta e dois reais e sete centavos).<br><br>
...
No segundo semestre de 2017, dando continuidade às Parcerias firmadas com as Prefeituras Municipais, tiveram início novas turmas nas extensões dos municípios de Sagres, na EMEF Prefeito Atilio Sani, do curso Técnico em Recursos Humanos e no município de Parapuã, na EMEF Profa. Zizi Pereira de Souza, de Técnico em Administração.</p><br><br>

<h1> ETEC no topo: Destaque de avaliações </h1>
<p class="lea">
...
<p class="lea">
No segundo semestre de 2018, na Etec sede, houve a implantação do curso Técnico em Desenvolvimento de Sistemas, em substituição ao curso Técnico em Processamento de Dados, por determinação do Centro Paula Souza, contando com os laboratórios e equipamentos já existentes na escola, cuja primeira turma funcionou no período da noite.<br>
...
Atualmente, além do Ensino Médio, do Técnico Integrado ao Ensino Médio (ETIM), do Ensino Médio com Itinerário Formativo e do Ensino Médio com Habilitação Profissional (Novotec).</p><br><br>

<div class="hmv-box2">
        <div class="container">
            <div class="row">
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="inner-hmv2">
                        <div class="icon-box-hmv2"><i class="flaticon-achievement"></i></div>
                        <h3>Nossa Missão</h3>
                        <div class="tr-pa">M</div>
                        <p><i> "Formar profissionais competentes para o futuro e para a vida." </i></p>
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12">
                    <div class="inner-hmv2">
                        <div class="icon-box-hmv2"><i class="flaticon-eye"></i></div>
                        <h3>Nossa Visão</h3>
                        <div class="tr-pa">V</div>
                        <p><i>"Manter o reconhecimento e referência da unidade e ensino que oferece Ensino Médio e Técnico de qualidade nos âmbitos local, regional e nacional."</i></p>
                    </div>
                </div>
            </div>
        </div>
...
Hoje, a Etec Amim Jundi oferece 21 Cursos: <br><br>
Ensino Médio;<br>
Ensino Médio com Itinerário Formativo - Linguagens, Ciências Humanas e Sociais;<br>
Ensino Médio com Habilitação Profissional de Técnico em Administração;<br>
Ensino Médio com Habilitação Profissional de Técnico em Desenvolvimento de Sistemas;<br>
Ensino Médio com Habilitação Profissional de Técnico em Química;<br>
Ensino Médio com Habilitação Profissional de Técnico em Recursos Humanos;<br>
Técnico em Açúcar e Álcool;<br>
Técnico em Administração;<br>
Técnico em Contabilidade;<br>
Técnico em Desenvolvimento de Sistemas;<br>
Técnico em Enfermagem;<br>
Técnico em Farmácia;<br>
Técnico em Informática para Internet;<br>
Técnico em Logística;<br>
Técnico em Marketing;<br>
Técnico em Meio Ambiente;<br>
Técnico em Informática;<br>
Técnico em Química;<br>
Técnico em Recursos Humanos;<br>
Técnico em Redes de Computadores;<br>
Técnico em Segurança do Trabalho.<br>
Conta ainda com Classe Descentralizada no município de Parapuã.<br>
<br>
Atualmente, a Etec conta com mais de 1000 alunos matriculados.<br>
</p><br><br>
<center>
