...
<html lang="en">
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     ...
     <!-- Site Metas -->
   <title>Resultados da pesquisa Downloads com: <?php echo $valor_pesquisar ?></title>  
...
<div class="col-lg-3 col-12 right-single">
    ...
    $pagina_atual = filter_input(INPUT_GET,'pagina', FILTER_SANITIZE_NUMBER_INT);       
        ...
        $result_evento = "SELECT * FROM downloads where titulo like '%$valor_pesquisar%' order by data desc LIMIT $inicio, $qnt_result_pg";
...
<?php
        ...
        $result_pg = "SELECT COUNT(cod_down) AS num_result FROM downloads where titulo LIKE '%$valor_pesquisar%' order by data desc";
...
<li class='page-item'><a class='page-link' href='pesquisaetecdownloads.php?pagina=<?php echo 1 ?>&pesquisar=<?php echo $valor_pesquisar; ?>'><span aria-hidden='true'>Primeira</span></a>
<?php
        for($pag_ant = $pagina - $max_links; $pag_ant <= $pagina - 1; $pag_ant++){
            if($pag_ant >= 1){ ?>
                <li class='page-item'><a class='page-link' href='pesquisaetecdownloads.php?pagina=<?php echo $pag_ant; ?>&pesquisar=<?php echo $valor_pesquisar; ?>'><?php echo $pag_ant ?></a></li>
                <?php
            }
        }
        ...
        for($pag_dep = $pagina + 1; $pag_dep <= $pagina + $max_links; $pag_dep++){
            ...
            <li class='page-item'><a class='page-link' href='pesquisaetecdownloads.php?pagina=<?php echo $pag_dep; ?>&pesquisar=<?php echo $valor_pesquisar; ?>'><?php echo $pag_dep ?></a></li>

            <?php } 
        }
            ?>  
<li class='page-item'><a class='page-link' href='pesquisaetecdownloads.php?pagina=<?php echo $quantidade_pg; ?>&pesquisar=<?php echo $valor_pesquisar; ?>'><span aria-hidden='true'>Última</span></a>
